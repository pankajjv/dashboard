        ...
        <div className="w-full h-screen relative">
            ...
            <header className={"fixed px-3 py-3 bg-slate-100 z-100 h-full top-0 left-0 " + (activelink ? "w-[178px]" : "w-[68px]")}>
                ...
                <div id="test" className='flex flex-col gap-4 mt-10 overflow-hidden'>
                    <Link to={'/dashboard'}>
                        <div className='p-2 hover:bg-blue-300 rounded-md flex items-center gap-4'>
            ...
            <main className={`bg-purple-100 py-4 ml-[68px] margin-transition duration-300 ${activelink ? "md:ml-[178px]" : ""}`}>
                <Outlet/>
            </main>
        </div>
    );
